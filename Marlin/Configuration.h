...
#define CUSTOM_MACHINE_NAME "3D Printer ZAV-PRO"
...
#define TEMP_RESIDENCY_TIME 12  // (seconds)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 208.01
  #define  DEFAULT_bedKi 9.19
  #define  DEFAULT_bedKd 1176.77
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 456.5 } //286
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1300, 1300, 60, 5000 }
...
//Чтобы приподнять сопло, нужно значение по модулю уменьшать. Т.е. прибавлять к этому отрицательному
